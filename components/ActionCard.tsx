    ...
    <View>
      ...
      <View style={[styles.card, styles.elevatedCard]}>
        ...
        <View style={styles.footerContainer}>
          <TouchableOpacity onPress={()=> openWebsite('https://dev.to/mdawooddev/10-must-know-javascript-es13-features-for-modern-development-3go3')}>
            <Text style={styles.socialLinks}>Read More</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={()=> openWebsite('https://github.com/muhammadasif46')}>
